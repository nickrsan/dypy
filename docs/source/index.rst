.. DyPy documentation master file, created by
   sphinx-quickstart on Thu Mar 21 13:19:53 2019.
...
tests may or may not work on a given day. `Get in touch <https://watershed.ucdavis.edu/user/64/contact>`_ if you have questions or want to contribute. If you just need
a working dynamic programming library now, check out `ProDyn <https://prodyn.readthedocs.io/en/latest/index.html>`_
...
DyPy was authored by `Nick Santos <https://nicksantos.com/>`_
